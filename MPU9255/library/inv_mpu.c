 ...
 * min(int a, int b)
 */
#if defined EMPL_TARGET_LPC43xx
#include "i2c.h"   
#include "mpu9255.h"
//#include "log.h"
...
#define i2c_read    MPU_Read_Len//Sensors_I2C_ReadRegister 
...
#elif defined EMPL_TARGET_ESP8266
// #include "i2c.h"   
#include "mpu9255.h"
#include "esp_libc.h"
//#include "log.h"
...
void mpu_delay_ms(uint32_t time)
{
    vTaskDelay(time / portTICK_RATE_MS);
}
#define i2c_write   MPU_Write_Len//Sensors_I2C_WriteRegister
#define i2c_read    MPU_Read_Len//Sensors_I2C_ReadRegister 
#define delay_ms    mpu_delay_ms //DelayMs
#define get_ms      get_tick_count
#define log_i       ets_printf//MPL_LOGI
#define log_e       ets_printf//MPL_LOGE
#define min(a,b) ((a<b)?a:b)
void get_tick_count(unsigned long *timestamp)
{
;
...
#ifndef EMPL_TARGET_ESP8266 // the same as EMPL_TARGET_LPC43xx 
    if (int_param)
