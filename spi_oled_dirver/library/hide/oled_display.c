...
//        oled_write_cmd(COLUMNADDR);
//        oled_write_cmd(minBoundX);
//        oled_write_cmd(maxBoundX);

//        oled_write_cmd(PAGEADDR);
...
//   if (geometry == GEOMETRY_128_64) {
    sendCommand(0x12);              // Set Higher Column Start Address for Page Addressing Mode (10h~1Fh)
...
//   }
 ...
 printf("minx:%d maxx:%d miny:%d maxy:%d\n",minBoundX,maxBoundX,minBoundY,maxBoundY);
    ...
    gpio_set_level(OLED_CS_GPIO, 0);
        ...
        // oled_set_pos(x,y);
        //     for(pos=0;pos<displayBufferSize;pos++)
        //     {
